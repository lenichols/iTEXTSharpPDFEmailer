...
public partial class Create252 : System.Web.UI.Page
{
    ...
    //var remoteFileName = Request.Form.Get("genUUID") + ".pdf";
    //var rawFileName = Request.Form.Get("genUUID");
...
public void SyncToFileManager(){
    ...
    string httpContainer = "http://xxx.xxx.xxx.xxx/UploadedFiles/" + filenamenew;
...
public void SendMsg()
{
        ...
        mm.Subject = "New xxxxxxx Completed - Field Evaluation from " + Request.Form.Get("Preparedby");
        ...
        client.Credentials = new System.Net.NetworkCredential("postmaster@xxx.xxxx-xxxxxx.com", "rackpassword");
                ...
                for (int i = 0; i < uploadFilCol.Count; i++)
                {
                    ...
                    if (fileName != string.Empty)
                    {
                        try
                        {
                            ...
                            {
                                //save to .net/iis virtual directory
